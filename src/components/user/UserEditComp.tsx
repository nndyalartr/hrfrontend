...
import { departmentOptions, designationOptions, genderOptions, mariatialStatusOptions, roleOptions } from "./AddUserPage";
        ...
        <>
            ...
            >
                ...
                <Row gutter={16} className="m-2">
                    <Col span={12}>
                        <Form.Item name="role" label="Role">
                            <Select placeholder="Please Select Type" options={roleOptions} />
                        </Form.Item>
                    </Col>
                    <Col span={12}>
                ...
                <Row gutter={16} className="m-2">
                    ...
                    <Col span={8}>
                        <Form.Item name="is_active" valuePropName="checked" label="Is Active User" rules={[{ required: true }]}>
                            <Checkbox ></Checkbox>
                        </Form.Item>
                    </Col>
                </Row>
