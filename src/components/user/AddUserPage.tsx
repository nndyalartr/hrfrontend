...
const AddUserPage = () => {
  ...
  return (
    <>
      <TopMenu />
      <Form className="" form={userAddForm} onFinish={addUser}>
        <Row gutter={16} className="m-2">
          ...
          <Col span={4}>
            <Form.Item
              name="is_esi_eligible"
              valuePropName="checked"
              label="Is ESI Eligible"
              rules={[{ required: true }]}
            >
              <Checkbox></Checkbox>
            </Form.Item>
        ...
        <Row gutter={16} className="m-2">
          ...
          <Col span={6}>
            <Form.Item name="martial_status" label="Martial Status">
              <Select
                placeholder="Please Select Type"
                options={mariatialStatusOptions}
              />
            </Form.Item>
          </Col>
          <Col span={6}>
